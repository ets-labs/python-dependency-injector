...
class DynamicContainer(Container):
    # Providers are added dynamically by name, so attribute access must resolve
    # to a Provider. This is intentionally absent from DeclarativeContainer,
    # whose providers are declared statically (see issue #910).
